...
namespace Gosub.Zurfur.Compiler
{
    ...
    static class CompileCode
    {
            ...
            SymFun currentFunction)
        {
            ...
            {
                if (!type.IsSpecialized || !type.HasGenericArg)
                    return type;
                ...
                return table.FindOrCreateSpecializedType(type.Parent,
                    NewGenericTypeParams(token, type.TypeArgs, args), type.TypeNames);
            }
            ...
            // Collect constraints on generic argument inType
