...
public partial class FormMain:Form
{
    ...
    BuildSystem        mBuildPackage = new BuildSystem(new FileSystemOs());
    ...
    private void TextEditor_TextChanged2(object sender, EventArgs e)
    {
        ...
        {
            mBuildPackage.SetLexer(textEditor.Lexer);
    ...
    /// </summary>
    private void mBuildPackage_StatusUpdate(object sender, BuildSystem.UpdatedEventArgs e)
    {
