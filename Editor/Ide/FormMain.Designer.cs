namespace Zurfur.Ide
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
            ...
            this.projectTree = new Zurfur.Ide.ProjectTree();
            this.labelPos = new System.Windows.Forms.Label();
            this.mvEditors = new Zurfur.Ide.MultiViewEditor();
            ...
            this.projectTree.FileDoubleClicked += new Zurfur.Ide.ProjectTree.FileInfoDelegate(this.projectTree_FileDoubleClicked);
            this.projectTree.FileMoved += new Zurfur.Ide.ProjectTree.FileMovedDelegate(this.projectTree_FileMoved);
            // 
            // labelPos
            // 
            ...
            this.mvEditors.EditorAdded += new Zurfur.Ide.MultiViewEditor.EditorDelegate(this.mvEditors_EditorAdded);
            this.mvEditors.EditorRemoved += new Zurfur.Ide.MultiViewEditor.EditorDelegate(this.mvEditors_EditorRemoved);
            this.mvEditors.EditorActiveViewChanged += new Zurfur.Ide.MultiViewEditor.EditorDelegate(this.mvEditors_EditorActiveViewChanged);
            this.mvEditors.EditorCanClose += new Zurfur.Ide.MultiViewEditor.EditorCanCloseDelegate(this.mvEditors_EditorCanClose);
            // 
            // buttonMax
            // 
